 ...
 */
public class MyLogRecyclerActivity extends BaseHttpRecyclerActivity<MyLog, MyLogView, MyLogAdapter> {
    ...
    public static Intent createIntent(Context context, int range) {
        return new Intent(context, MyLogRecyclerActivity.class).putExtra(INTENT_RANGE, range);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.log_recycler_activity);
    ...
    public void getListAsync(final int page) {
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            @Override
            public void run() {
                onHttpResponse(-page, page >= 5 ? null : JSON.toJSONString(TestUtil.getMyLogList(page, 10)), null);
            }
        }, 1000);
        //仅测试用>>>>>>>>>>>>
    }
